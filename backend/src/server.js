...
app.delete("/api/customers/:id",auth(["ceo","admin"]),asyncRoute(async(req,res)=>{await pool.query("delete from customers where id=$1",[req.params.id]);res.status(204).end();}));
