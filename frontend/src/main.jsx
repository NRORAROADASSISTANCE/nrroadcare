...
function CeoRoot(){return <AppErrorBoundary><CeoApp/><Suspense fallback={null}><CustomerDetailsOverlay/></Suspense></AppErrorBoundary>}
const root=createRoot(document.getElementById("root"));
if(isCeoMode&&ceoToken)root.render(<CeoRoot/>);else if(tokenRole==="mechanic")root.render(<AppErrorBoundary><MechanicApp/></AppErrorBoundary>);else root.render(<AdminRoot/>);
