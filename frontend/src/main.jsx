...
const Access=()=> <Suspense fallback={null}><CustomerRegistrationAccess/></Suspense>;
function AdminRoot(){return <HashRouter><AppErrorBoundary><App/><Access/></AppErrorBoundary></HashRouter>}
function CeoRoot(){return <AppErrorBoundary><CeoApp/><Access/></AppErrorBoundary>}
function MechanicRoot(){return <AppErrorBoundary><MechanicApp/><Access/></AppErrorBoundary>}
const root=createRoot(document.getElementById("root"));
if(isCeoMode&&ceoToken)root.render(<CeoRoot/>);else if(tokenRole==="mechanic")root.render(<MechanicRoot/>);else root.render(<AdminRoot/>);
